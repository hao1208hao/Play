...
//add by :孟亮亮
+ (NSString *)sign:(NSString *)str privateKey:(NSString *)privKey{
    //1.加密
    NSData * data1 = [str dataUsingEncoding:NSUTF8StringEncoding];
    NSData * encrypt = [RSA encryptData:data1 privateKey:privKey];
    NSData * signedData = [encrypt MD5];
    NSData * base6Data = [signedData base64EncodedData];
    return [[NSString alloc]initWithData:base6Data encoding:NSUTF8StringEncoding];
}
@end
